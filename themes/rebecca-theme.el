...
(let* ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(trailing-whitespace ((,class (:foreground ,ninja))))
   ...
   `(whitespace-trailing ((,class (:foreground ,ninja))))
;;   `(whitespace-trailing ((,class :inherit trailing-whitespace)))
   `(whitespace-tab ((,class (:foreground ,ninja))))
   `(whitespace-line ((,class :background ,ninja :foreground unspecified)))
   ;; syntax
