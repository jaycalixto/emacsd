...
;;;;; font lock
   `(font-lock-builtin-face                       ((t (:foreground ,acme-green-alt :weight normal))))
   `(font-lock-function-name-face                 ((t (:foreground ,acme-cyan :weight normal))))
   `(font-lock-function-call-face                 ((t (:foreground ,acme-blue :weight normal))))
   ...
   `(font-lock-variable-name-face                 ((t (:foreground ,acme-yellow :weight normal))))
   ...
   `(font-lock-number-face                        ((t (:foreground ,acme-purple :weight normal))))
